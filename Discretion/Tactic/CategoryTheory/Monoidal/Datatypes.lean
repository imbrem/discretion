...
import Discretion.Tactic.CategoryTheory.MonoidalComp
...
instance : Mathlib.Tactic.BicategoryLike.Context Monoidal.Context where
...
instance : Mathlib.Tactic.BicategoryLike.MkMor₂ MonoidalM where
  ofExpr := Mor₂OfExpr
